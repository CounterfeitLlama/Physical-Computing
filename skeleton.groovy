...
CSG hand = cylinder.difference(new Cylinder(13, 13, 10, (int)30).toCSG().movex(leftHandX).movey(leftHandY).movez(leftHandZ)).difference(cube).scalex(0.5).scaley(0.5).scalez(0.5)
...
CSG spine = new Cylinder(7, 7, 54, (int)30).toCSG().movex(135).movey(188).movez(72).setColor(javafx.scene.paint.Color.WHITE)
spine = spine.union(new Cylinder(7-1, 7-1, 6, (int)30).toCSG().movex(135).movey(188).movez(126)).setColor(javafx.scene.paint.Color.WHITE)
CSG[] spinalCords = [
